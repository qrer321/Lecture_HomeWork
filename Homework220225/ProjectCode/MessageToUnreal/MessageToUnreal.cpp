...
// 폴더에 따라 변경해서 사용
#define UNREAL_CLIENT_MESSAGE_DIR "UnrealClient\\Source\\Message"
...
int main()
{
	...
	//////////////////////////////////////// Check Unreal Folder /////////////////////////////////////////
	{
		GameServerDirectory check_dir;
		if (false == check_dir.MoveToParent("ProjectCode"))
		{
			return 1;
		}
		check_dir.MoveToParent();

		if (false == check_dir.MoveToChild(UNREAL_CLIENT_MESSAGE_DIR))
		{
			return 1;
		}

		if (false == check_dir.MoveToChild("Handler"))
		{
			return 1;
		}
	}
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
	{
		/////////////////////////////////////// Copy GameServerBase //////////////////////////////////////
		{
			...
			if (false == save_dir.MoveToParent("ProjectCode"))
			{
				return 1;
			}
